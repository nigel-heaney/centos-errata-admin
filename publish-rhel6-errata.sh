...
YUMBASEPATH=/var/www/html/repo/rhel-x86_64-server-6
REPOMDDIR=/var/www/html/repo/rhel-x86_64-server-6/getPackage/repodata
YUMCACHEFILE=/var/cache/yum/x86_64/6Server/rhel-6-server-rpms/gen/updateinfo.xml
RELEASE=6
